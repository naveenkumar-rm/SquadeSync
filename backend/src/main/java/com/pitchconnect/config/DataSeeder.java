    ...
    public CommandLineRunner seedData(UserRepository userRepository, MatchRepository matchRepository) {
        return args -> {
            if (userRepository.count() == 0) {
                ...
                User alex = new User("u1", "Alex Mercer", "alexm", "alex@example.com", "password", "https://api.dicebear.com/7.x/avataaars/svg?seed=Alex", 98, 42, null, null, new ArrayList<>());
                User john = new User("u2", "John D.", "johnd", "john@example.com", "password", "https://api.dicebear.com/7.x/avataaars/svg?seed=John", 95, 30, null, null, new ArrayList<>());
                User sarah = new User("u3", "Sarah M.", "sarahm", "sarah@example.com", "password", "https://api.dicebear.com/7.x/avataaars/svg?seed=Sarah", 90, 20, null, null, new ArrayList<>());
                User mike = new User("u4", "Mike T.", "miket", "mike@example.com", "password", "https://api.dicebear.com/7.x/avataaars/svg?seed=Mike", 85, 10, null, null, new ArrayList<>());
